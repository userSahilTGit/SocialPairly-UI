...
import { ShieldAlert, Search, X, CheckCircle2, AlertCircle, Play, Clock, MessageSquare, User } from 'lucide-react';
    ...
    <div className="container">
      <div className="flex-between" style={{ marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <h1 style={{ margin: 0 }}>Media Moderation Center</h1>
            <p style={{ color: 'var(--muted)', fontSize: 14, margin: 0 }}>
              Post-moderation: review all live media and take down violating content
            </p>
          </div>
        </div>
      ...
      {/* Stats */}
      <div className="grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 12, marginBottom: 20 }}>
        {[
      ...
      {/* Media Grid */}
      {loading ? (
        <div className="center">Loading media for moderation...</div>
        ...
        <div className="grid-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 16 }}>
